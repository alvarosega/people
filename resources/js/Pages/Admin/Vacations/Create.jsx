...
export default function Create({ auth, usuarios }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.vacations.store'));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Registrar Vacaciones</h2>}
        >
            <Head title="Crear Vacaciones" />
